...
import { EngagementPanel } from "@/components/engagement";
import { changeLabel } from "@/lib/insights";
...
export default function AnalyticsPage() {
  ...
  const cards = [
    ...
    { label: days === 1 ? "New today" : `New in ${days} days`, value: data.metrics.newUsers, hint: changeLabel(data.metrics.newUsers, data.metrics.previousNewUsers), trend: growth },
    ...
    { label: "AI requests", value: data.metrics.aiRequests, hint: "Selected period" },
  ];
