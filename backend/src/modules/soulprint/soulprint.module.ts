...
@Module({
  ...
  providers: [SoulprintService, SoulprintMergeService, SoulprintSummaryService, SoulprintContextService, SoulprintExtractionService, SoulprintMatchingAdapterService],
  exports: [SoulprintService, SoulprintContextService, SoulprintExtractionService, SoulprintMatchingAdapterService],
})
