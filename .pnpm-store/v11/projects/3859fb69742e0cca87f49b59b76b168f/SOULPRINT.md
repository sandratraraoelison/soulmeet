...
The structured summary uses only active and confirmed entries. Completeness measures coverage—not a person's psychological value—with capped weights for relationship goals, values, interests, communication, preferences, boundaries, emotional needs, and personality.
