  ...
  return (
    <SafeAreaView className="flex-1 bg-canvas">
      ...
      <View className="flex-1 items-center justify-center px-8">
        <View className="h-24 w-24 items-center justify-center rounded-full border border-[#E9694F]/40 bg-[#191821]">
          <ActivityIndicator size="large" color="#E9694F" />
        </View>
        <Text className="mt-9 text-center text-[30px] font-bold text-ink">
          Your coach is{`\n`}
          <Text className="text-[#E9694F]">getting ready.</Text>
        </Text>
