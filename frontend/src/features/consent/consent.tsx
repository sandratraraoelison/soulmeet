      ...
      <View className="flex-1 justify-center bg-black/80 px-4 py-8">
        <ScrollView contentContainerClassName="grow justify-center" keyboardShouldPersistTaps="handled">
          <View className="rounded-[28px] border border-border bg-surface p-6">
            ...
            <Text className="mt-3 text-sm leading-6 text-muted">If you allow access, the AI will analyze relevant patterns from your conversations to improve your Soulprint. This analysis is automated, and no human will read or access your conversations for this purpose. Your private messages will not be displayed in your Soulprint, and Soulmeet will never send messages or speak on your behalf.</Text>
